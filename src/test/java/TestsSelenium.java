...
public class TestsSelenium {
    ...
    @Test
    public void testInputFieldsDemoQA() {
...
//        driver.findElement(By.id("username"));
    ...
    public void testInputFieldsSeleniumEasy() {
        ...
        wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//*[@id='at-cv-lightbox-win']")));
    ...
    public void testTwoInputFieldsSeleniumEasy() {
        ...
        Assert.assertEquals(textTotal,Integer.toString(intupSum));
